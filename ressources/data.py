...
async def get_information():
    ...
    for car in cars:
        ...
        print("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
        print(f"Summary mois: {[[x] for x in await car.get_summary(date.today() - timedelta(days=30), date.today(), summary_type=SummaryType.YEARLY)]}" )
        print("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
        print(f"Summary année: {[[x] for x in await car.get_summary(date.today() - timedelta(days=10 * 365), date.today(), summary_type=SummaryType.YEARLY)]}")
        print("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
